...
| 错误码 | 描述                           | 详细说明                                                              |
| ------ | ------------------------------ | --------------------------------------------------------------------- |
| 4001   | 请求体缺失或格式错误              | 请求体缺失或者请求体不是合法的 JSON 格式。                                                |
| 4002   | 请求参数类型错误                   | 请求参数中的字段类型错误，例如期望整数但传入了字符串。                                |
| 4003   | 请求参数值超出范围                 | 请求参数中的字段值超出允许的范围，例如生字率大于 1 或小于 0，或者目标级别小于 1 或者大于 100。                                |
| 4004 |  无效的 UUID                    |   请求参数中的 UUID 格式不正确。                                  |
| 4005  |  分页参数错误        | 请求参数中的分页参数错误，例如页码或每页数量为负数。                               |
